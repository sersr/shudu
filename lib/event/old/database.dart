// import 'package:shudu/database/nop.dart';
...
//   @override
//   Future<void> updateBookStatus(BookCache bookCache) async {
    
//     await _db.rawUpdate(
//         'update BookInfo set chapterId = ?, cPage = ?, isNew = ?,sortKey = ? where bookId = ?',
//         [bookcache.cid, page, 0, DateTime.now().millisecondsSinceEpoch, id]);
//   }
