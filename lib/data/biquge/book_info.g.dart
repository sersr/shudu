...
BookVote _$BookVoteFromJson(Map<String, dynamic> json) => BookVote(
...
SameUserBook _$SameUserBookFromJson(Map<String, dynamic> json) => SameUserBook(
      id: json['Id'] as int?,
...
BookInfoRoot _$BookInfoRootFromJson(Map<String, dynamic> json) => BookInfoRoot(
      data: json['data'] == null
          ? null
