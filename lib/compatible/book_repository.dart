...
class BookRepository extends Repository {
  ...
  Future<void> initState() async {
    ...
    _futures.add(Future(() async {
      ...
      _secF.add(Future(() async {
        ...
        _isolate = await Isolate.spawn(_isolateNet, [clientRP.sendPort, appPath]);
    ...
    bookEvent = BookEventMain(repository: this);

    _futures.add(bookEvent.initState());
  ...
  Future<String> saveImage(String img) async {
    return sendMessage<String>(MessageType.saveImage, img);
  }
...
Dio dioCreater() => Dio(
      BaseOptions(
        ...
        headers: {
          ...
          HttpHeaders.userAgentHeader: 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36'
