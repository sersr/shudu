...
class _WaterPainter extends CustomPainter {
  ...
  _WaterPainter({required this.color, required this.listener, required this.ratio}) : super(repaint: listener);
...
class _BezierPainter extends CustomPainter {
  ...
  _BezierPainter({required this.listener, required this.color}) : super(repaint: listener);
